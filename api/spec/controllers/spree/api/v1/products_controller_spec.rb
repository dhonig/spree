...
<<<<<<< HEAD:api/spec/controllers/spree/api/v1/products_controller_spec.rb
=======
...
>>>>>>> Add v1 namespace for API.:api/spec/controllers/spree/api/v1/products_controller_spec.rb
